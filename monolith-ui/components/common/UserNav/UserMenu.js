    ...
    <div className='flex justify-center items-center font-rubik text-secondary'>
        ...
        <Link href='/cart'>
          <a className='contents'>
            <button className='h-6 focus:outline-none'>
              <FontAwesomeIcon icon={faShoppingCart} size='2x' className='w-full h-full text-secondary cursor-pointer'/>
            </button>
          </a>
        </Link>
      </div>
      ...
      >
        <div className='flex justify-center items-center h-6'>
          ...
          <FontAwesomeIcon icon={faUser} size='2x' className='h-full w-full text-secondary' />
        </div>
        {display && (
