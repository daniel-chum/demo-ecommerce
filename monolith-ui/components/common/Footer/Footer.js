  ...
  return (
    <div className="px-14 pt-10 bg-secondary text-white font-rubik font-light" style={{ fontSize: '0.9rem' }}>
      <div className='flex flex-col lg:flex-row justify-between ' >
        ...
        <ul className='flex flex-col  gap-y-3 pt-10 lg:pt-3.5'>
        ...
        <ul className='flex flex-col gap-y-3 pt-10 lg:pt-3.5'>
          ...
          <Link href='/account'><a><li className='cursor-pointer'>Account</li></a></Link>
        ...
        <div className='flex flex-col gap-y-3 pt-10 lg:pt-3.5'>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-center border-t border-gray-50 border-opacity-10 mt-8 pt-2 pb-2'>
